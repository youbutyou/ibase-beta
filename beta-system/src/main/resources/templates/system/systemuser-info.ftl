    ...
    <form method="POST" style="margin: 0;">
        <div style="padding: 10px; text-align: right;">
            ...
            <table style="border-collapse: separate; border-spacing: 0px 8px; font-size: 12px">
                            <tr>
                    <td style="text-align: right;">编码&nbsp</td>
                    <td><input name="sn" class="ccrfid-readonly" style="height: 25px; width: 200px;"></td>
                </tr>
                <tr>
                    <td style="text-align: right;">姓名&nbsp</td>
                    <td><input name="iname" class="ccrfid-readonly" style="height: 25px; width: 200px;"></td>
                </tr>
                <tr>
                    <td style="text-align: right;">密码&nbsp</td>
                    <td><input name="password" class="ccrfid-readonly" style="height: 25px; width: 200px;"></td>
                </tr>
                <tr>
                    <td style="text-align: right;">手机号码&nbsp</td>
                    <td><input name="phone" class="ccrfid-readonly" style="height: 25px; width: 200px;"></td>
                </tr>
                <tr>
                    <td style="text-align: right;">组织编码&nbsp</td>
                    <td><input name="orgSn" class="ccrfid-readonly" style="height: 25px; width: 200px;"></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="text-align: right;">添加/编辑时间&nbsp</td>
                    <td><input name="editTime" class="ccrfid-readonly" style="height: 25px; width: 200px;"></td>
                </tr>
                <tr>
                    <td style="text-align: right;">添加/编辑人员&nbsp</td>
